...
1. Explain how you got the HTML, with the correct data, displayed in the browser?
   > In main.js, I used document.querySelector('.potteryList') to grab the HTML element with the class "potteryList". I then assigned the displayPottery variable the value of what the function PotteryList() returns. The return value of PotteryList() is a compiled string consisting of HTML syntax and text where I was able to plug in the property values of the pottery objects that I wanted to display into the string through template literals.
